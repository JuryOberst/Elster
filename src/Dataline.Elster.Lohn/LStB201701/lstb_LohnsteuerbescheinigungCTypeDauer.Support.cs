    ...
    public partial class lstb_LohnsteuerbescheinigungCTypeDauer
    {
        ...
        public DateTime? AnfangDatum
        {
            get
            {
                DateTime result;
                if (
                    !DateTime.TryParseExact(Anfang + XmlSchemaUtilities.GetEnumXmlValue(jahr), "ddMMyyyy", CultureInfo.InvariantCulture,
        ...
        public DateTime? EndeDatum
        {
            get
            {
                DateTime result;
                if (
                    !DateTime.TryParseExact(Ende + XmlSchemaUtilities.GetEnumXmlValue(jahr), "ddMMyyyy", CultureInfo.InvariantCulture,
                        System.Globalization.DateTimeStyles.None, out result))
                    return null;
                return result;
            }

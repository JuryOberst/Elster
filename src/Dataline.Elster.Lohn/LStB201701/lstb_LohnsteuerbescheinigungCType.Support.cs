...
namespace Dataline.Elster.Lohn.LStB201701
{
    public partial class lstb_LohnsteuerbescheinigungCType : ILohnsteuerBescheinigung
    {
        ...
        private IEnumerable<lstb_BesteuerungsmerkmaleCTypeELStAM> FilterBesteuerungsmerkmale<T>(
            Func<lstb_BesteuerungsmerkmaleCTypeELStAM, T> getCompareItem, Action<lstb_BesteuerungsmerkmaleCTypeELStAM> setNewItem) where T : class
        {
        ...
        {
            get { return FilterBesteuerungsmerkmale(x => x.Kinder, x => x.Kinder = new lstb_BesteuerungsmerkmaleCTypeELStAMKinder()); }
        }
        ...
        public IEnumerable<lstb_BesteuerungsmerkmaleCTypeELStAM> BesteuerungsmerkmaleKirchensteuerabzug
        {
            get
            {
                return FilterBesteuerungsmerkmale(x => x.Kirchensteuerabzug,
                    x => x.Kirchensteuerabzug = new lstb_BesteuerungsmerkmaleCTypeELStAMKirchensteuerabzug());
            }
        }
        ...
        public IEnumerable<lstb_BesteuerungsmerkmaleCTypeELStAM> BesteuerungsmerkmaleHinzurechnungsbetrag
        {
            get
            {
                return FilterBesteuerungsmerkmale(x => x.Hinzurechnungsbetrag,
                    x => x.Hinzurechnungsbetrag = new lstb_BesteuerungsmerkmaleCTypeELStAMHinzurechnungsbetrag
                    {
                        jahr = string.Empty,
                        monat = string.Empty,
                    });
        ...
        public IEnumerable<lstb_BesteuerungsmerkmaleCTypeELStAM> BesteuerungsmerkmaleSteuerfreibetrag
        {
            get
            {
                return FilterBesteuerungsmerkmale(x => x.Steuerfreibetrag,
                    x => x.Steuerfreibetrag = new lstb_BesteuerungsmerkmaleCTypeELStAMSteuerfreibetrag
                    {
                        jahr = string.Empty,
                        monat = string.Empty,
                    });

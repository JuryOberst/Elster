// <copyright file="SchemaResourceTests.cs" company="DATALINE GmbH &amp; Co. KG">
...
namespace Dataline.Elster.Test
{
    public class SchemaResourceTests
    {
        ...
        [InlineData(typeof(Datenabholung.V5.DatenabholungResourceProvider))]
        [InlineData(typeof(Datenabholung.V6.DatenabholungResourceProvider))]
